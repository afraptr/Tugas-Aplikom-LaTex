...
\end{eulercomment}
\eulersubheading{Basic Plots (Plots Dasar)}
\begin{eulercomment}
...
>n=30; X=random(n,2); Y=random(n,2);  // get random points
>colors=rgb(random(n),random(n),random(n)); // get random colors
>loop 1 to n; color(colors[#]); plot(X[#],Y[#]); end; // plot
>hold off; // end overwrite mode
>insimg; // insert to notebook
\end{eulerprompt}
\eulerimg{27}{images/Plot 2D_Afra Putri Soliana_22305144025-001.png}
\begin{eulerprompt}
>reset;
\end{eulerprompt}
\begin{eulercomment}
...
>plot2d("x^4-x",grid=6):
\end{eulerprompt}
\eulerimg{27}{images/Plot 2D_Afra Putri Soliana_22305144025-002.png}
\begin{eulerprompt}
>hold off;
>window(ow);
\end{eulerprompt}
...
\end{eulercomment}
\eulersubheading{Plot Aspect (Plot Aspek)}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/Plot 2D_Afra Putri Soliana_22305144025-003.png}
\begin{eulerprompt}
>aspect();
>reset;
\end{eulerprompt}
...
\begin{eulercomment}
\eulerheading{2D Plots in Euler (Plot 2D di Euler)}
\begin{eulercomment}
...
>plot2d("x^2"):
\end{eulerprompt}
\eulerimg{27}{images/Plot 2D_Afra Putri Soliana_22305144025-004.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("x^3-x"):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-005.png}
\begin{eulerprompt}
>a:=5.6; plot2d("exp(-a*x^2)/a"); insimg(30); // menampilkan gambar hasil plot setinggi 25 baris
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-006.png}
\begin{eulercomment}
...
>plot2d("x^3-x",-1,2):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-007.png}
\begin{eulerprompt}
>plot2d("sin(x)",-2*pi,2*pi): // plot sin(x) pada interval [-2pi, 2pi]
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-008.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(2*x)",xmin=0,xmax=2pi):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-009.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/Plot 2D_Afra Putri Soliana_22305144025-010.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/Plot 2D_Afra Putri Soliana_22305144025-011.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-012.png}
\begin{eulerprompt}
>plot2d("sin(x)+cos(2*x)",0,4pi):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-013.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-014.png}
\begin{eulerprompt}
>plot2d("x^x",r=1.2,cx=1,cy=1):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-015.png}
\begin{eulercomment}
...
>plot2d("log(x)",-0.1,3):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-016.png}
\begin{eulercomment}
...
>plot2d("x^3-x",>square):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-017.png}
\begin{eulerprompt}
>plot2d(''integrate("sin(x)*exp(-x^2)",0,x)'',0,2): // plot integral
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-019.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-020.png}
\begin{eulerprompt}
>a:=5.6; expr &= exp(-a*x^2)/a; // define expression
>plot2d(expr,-2,2): // plot from -2 to 2
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-021.png}
\begin{eulerprompt}
>plot2d(expr,r=1,thickness=2): // plot in a square around (0,0)
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-022.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x),>add,style="--",color=red): // add another plot
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-023.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x,2),a=-2,b=2,c=-2,d=2): // plot in rectangle
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-024.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x),a=-2,b=2,>square): // keep plot square
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-025.png}
\begin{eulerprompt}
>plot2d("x^2",0,1,steps=1,color=red,n=10):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-026.png}
\begin{eulerprompt}
>plot2d("x^2",>add,steps=2,color=blue,n=10):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-027.png}
\eulerheading{Functions in one Parameter (Fungsi dalam Satu Parameter)}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-028.png}
\begin{eulerprompt}
>plot2d("f",0,1;0.4): // plot with a=0.4
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-029.png}
\begin{eulerprompt}
>plot2d(\{\{"f",0.2\}\},0,1): // plot with a=0.2
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-030.png}
\begin{eulerprompt}
>plot2d(\{\{"f(x,b)",b=0.1\}\},0,2): // plot with 0.1
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-031.png}
\begin{eulerprompt}
>function f(x) := x^3-x; ...
>plot2d("f",r=1):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-032.png}
\begin{eulercomment}
...
>plot2d(f,0,2):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-033.png}
\begin{eulercomment}
...
>plot2d(expr,0,3pi):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-034.png}
\begin{eulerprompt}
>function f(x) &= x^x;
>plot2d(f,r=1,cx=1,cy=1,color=blue,thickness=2);
>plot2d(&diff(f(x),x),>add,color=red,style="-.-"):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/Plot 2D_Afra Putri Soliana_22305144025-037.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/Plot 2D_Afra Putri Soliana_22305144025-038.png}
...
\end{eulerprompt}
\eulerimg{27}{images/Plot 2D_Afra Putri Soliana_22305144025-039.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("sin(x)",0,2pi); plot2d("cos(x)",color=blue,style="--",>add):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-041.png}
\begin{eulercomment}
Kami menambahkan titik persimpangan dengan label (pada posisi "cl"
untuk kiri tengah/center left), dan memasukkan hasilnya ke dalam
notebook. Kami juga menambahkan judul ke plot.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-042.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-044.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-046.png}
\begin{eulercomment}
...
>plot2d(x,y):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-048.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-049.png}
\begin{eulerprompt}
>plot2d(["sin(x)","cos(x)"],0,2pi): // plot vector ekspresi
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-050.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-051.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-052.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-053.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-054.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-055.png}
\eulersubheading{Text Labels (Label Teks)}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-056.png}
\begin{eulerprompt}
>expr := "log(x)/x"; ...
>  plot2d(expr,0.5,5,title="y="+expr,xl="x",yl="y"); ...
>  label("(1,0)",1,0); label("Max",E,expr(E),pos="lc"):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-057.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-058.png}
\begin{eulercomment}
...
>tcolor=black,>left):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-059.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-060.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-061.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-062.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-063.png}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-064.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-065.png}
\begin{eulercomment}
...
>  x=0.7,y=0.2):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-066.png}
\begin{eulercomment}
\end{eulercomment}
\eulersubheading{User Interaction (Interaksi Pengguna)}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Plot 2D_Afra Putri Soliana_22305144025-067.png}
\begin{eulerprompt}
>plot2d("exp(x)*sin(x)",user=true, ...
>  title="+/- or cursor keys (return to exit)"):
\end{eulerprompt}
\eulerimg{27}{images/Plot 2D_Afra Putri Soliana_22305144025-068.png}
\begin{eulercomment}
...
\end{eulercomment}
\begin{eulerprompt}
>t=-1:0.5:1; dragpoints("plotf",t,random(size(t))-0.8):
\end{eulerprompt}
\eulerimg{27}{images/Plot 2D_Afra Putri Soliana_22305144025-069.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Plot 2D_Afra Putri Soliana_22305144025-070.png}
\begin{eulercomment}
...
>plotf(nd):
\end{eulerprompt}
\eulerimg{27}{images/Plot 2D_Afra Putri Soliana_22305144025-071.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulersubheading{Styles of 2D Plots (Gaya Plot 2D)}
\begin{eulercomment}
...
> figure(0):
\end{eulerprompt}
\eulerimg{27}{images/Plot 2D_Afra Putri Soliana_22305144025-072.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-073.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Plot 2D_Afra Putri Soliana_22305144025-074.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Plot 2D_Afra Putri Soliana_22305144025-075.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Plot 2D_Afra Putri Soliana_22305144025-076.png}
\begin{eulercomment}
Ada juga kotak teks.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/Plot 2D_Afra Putri Soliana_22305144025-077.png}
\begin{eulerprompt}
>plot2d(["exp(x)","1+x"],color=[black,blue],style=["-","-.-"]):
\end{eulerprompt}
\eulerimg{27}{images/Plot 2D_Afra Putri Soliana_22305144025-078.png}
\begin{eulerprompt}
...
> reset():
\end{eulerprompt}
\eulerimg{27}{images/Plot 2D_Afra Putri Soliana_22305144025-079.png}
\begin{eulercomment}
...
> reset:
\end{eulerprompt}
\eulerimg{27}{images/Plot 2D_Afra Putri Soliana_22305144025-080.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-081.png}
\eulerheading{Plotting 2D Data (Merencanakan data 2D)}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-082.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-083.png}
\begin{eulerprompt}
>p=polyfit(xdata,ydata,1); // get regression line
>plot2d("polyval(p,x)",>add,color=green): // add plot of line
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-084.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{14}{images/Plot 2D_Afra Putri Soliana_22305144025-085.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/Plot 2D_Afra Putri Soliana_22305144025-086.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); ...
>plot2d(cos(t),sin(t),>filled,style="/",fillcolor=red,r=1.2):
\end{eulerprompt}
\eulerimg{14}{images/Plot 2D_Afra Putri Soliana_22305144025-087.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); plot2d(cos(t),sin(t),>filled,style="#"):
\end{eulerprompt}
\eulerimg{14}{images/Plot 2D_Afra Putri Soliana_22305144025-088.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/Plot 2D_Afra Putri Soliana_22305144025-089.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/Plot 2D_Afra Putri Soliana_22305144025-090.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/Plot 2D_Afra Putri Soliana_22305144025-091.png}
\begin{eulercomment}
...
> plot2d(t,t,add=true):
\end{eulerprompt}
\eulerimg{14}{images/Plot 2D_Afra Putri Soliana_22305144025-092.png}
\begin{eulercomment}
...
>plot2d(t,y):
\end{eulerprompt}
\eulerimg{14}{images/Plot 2D_Afra Putri Soliana_22305144025-093.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/Plot 2D_Afra Putri Soliana_22305144025-094.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/Plot 2D_Afra Putri Soliana_22305144025-096.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(x)^3",xmin=0,xmax=2pi,>filled,style="/"):
\end{eulerprompt}
\eulerimg{14}{images/Plot 2D_Afra Putri Soliana_22305144025-097.png}
...
\end{eulerprompt}
\eulerimg{14}{images/Plot 2D_Afra Putri Soliana_22305144025-099.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/Plot 2D_Afra Putri Soliana_22305144025-100.png}
\begin{eulerprompt}
>t=linspace(0,1,1000); r=exp(-t); x=r*cos(2pi*t); y=r*sin(2pi*t);
>plot2d(x,y,r=1):
\end{eulerprompt}
\eulerimg{14}{images/Plot 2D_Afra Putri Soliana_22305144025-101.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulerprompt}
>t=linspace(0,4pi,1000); r=1+sin(3*t)/2; x=r*cos(t); y=r*sin(t); ...
>plot2d(x,y,>filled,fillcolor=red,style="/",r=1.5):
\end{eulerprompt}
\eulerimg{14}{images/Plot 2D_Afra Putri Soliana_22305144025-104.png}
...
\end{eulerprompt}
\eulerimg{27}{images/Plot 2D_Afra Putri Soliana_22305144025-105.png}
\begin{eulerprompt}
>aspect(1.25); r=linspace(0,1,50); a=linspace(0,2pi,200)'; z=r*exp(I*a);
>plot2d(exp(z),cgrid=[40,10]):
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-106.png}
\begin{eulerprompt}
>r=linspace(0,1,10); a=linspace(0,2pi,40)'; z=r*exp(I*a);
>plot2d(exp(z),>points,>add):
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-107.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-108.png}
\eulerheading{Statistical Plots (Plot Statistik)}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-109.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-110.png}
\begin{eulerprompt}
>columnsplot(cumsum(random(10)),style="/",color=blue):
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-111.png}
\begin{eulercomment}
...
>title("Temperature"):
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-112.png}
\begin{eulerprompt}
>k=0:10;
>plot2d(k,bin(10,k),>bar):
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-113.png}
\begin{eulerprompt}
>plot2d(k,bin(10,k)); plot2d(k,bin(10,k),>points,>add):
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-114.png}
\begin{eulerprompt}
>plot2d(normal(1000),normal(1000),>points,grid=6,style=".."):
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-115.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution,style="O"):
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-116.png}
\begin{eulerprompt}
>plot2d("qnormal",0,5;2.5,0.5,>filled):
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-117.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-118.png}
\begin{eulercomment}
...
>plot2d(x,y,>bar):
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-119.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-120.png}
\begin{eulerprompt}
>n=10; i=0:n; ...
>plot2d(i,bin(n,i)/2^n,a=0,b=10,c=0,d=0.3); ...
>plot2d(i,bin(n,i)/2^n,points=true,style="ow",add=true,color=blue):
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-121.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-122.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-123.png}
\begin{eulerprompt}
>k=0:10; m=bin(10,k); x=(0:11)-0.5; plot2d(x,m,>bar):
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-124.png}
\begin{eulerprompt}
>columnsplot(m,k):
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-125.png}
\begin{eulerprompt}
>plot2d(random(600)*8,histogram=8):
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-126.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-127.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-128.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-129.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution); ...
>  plot2d("qnormal(x)",color=red,thickness=2,>add):
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-130.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/Plot 2D_Afra Putri Soliana_22305144025-131.png}
\eulerheading{Implicit Functions (Fungsi Implisit)}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-132.png}
\begin{eulerprompt}
>expr := "2*x^2+x*y+3*y^4+y"; // define an expression f(x,y)
>plot2d(expr,level=0): // Solutions of f(x,y)=0
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-133.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,contourcolor=white,n=200): // nice
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-134.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,>spectral,n=200,grid=4): // nicer
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-135.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-136.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",>contour,>hue,>spectral):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-137.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",level=0,contourwidth=3,>add,contourcolor=blue):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-138.png}
\begin{eulerprompt}
>z=z+normal(size(z))*0.2;
>plot2d(z,level=0.5,a=-1,b=2,c=-2,d=1):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-139.png}
\begin{eulerprompt}
>plot2d(expr,level=[0:0.2:5;0.05:0.2:5.05],color=lightgray):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-140.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=1,r=4,n=100):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-141.png}
\begin{eulerprompt}
>plot2d("x^2+2*y^2-x*y",level=0:0.1:10,n=100,contourcolor=white,>hue):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-142.png}
\begin{eulercomment}
...
>plot2d(expr,level=[0;1],style="-",color=blue): // 0 <= f(x,y) <= 1
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-143.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-144.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=[0,2,4;1,3,5],style="/",r=2,n=100):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-145.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=-10:20,r=2,style="-",dl=0.1,n=100):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-146.png}
\begin{eulerprompt}
>plot2d("sin(x)*cos(y)",r=pi,>hue,>levels,n=100):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-147.png}
\begin{eulercomment}
...
>  level=[-2;0],n=100):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-149.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-150.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/Plot 2D_Afra Putri Soliana_22305144025-151.png}
\begin{eulercomment}
...
>logimpulseplot1(x,y):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-152.png}
\begin{eulercomment}
...
Plot logaritmik dapat diplot menggunakan skala logaritmik di y dengan
logplot = 1, atau menggunakan skala logaritmik di x dan y dengan
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-153.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",0,100,logplot=1):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-154.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",10,100,logplot=2):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-155.png}
\begin{eulerprompt}
>plot2d("gamma(x)",1,10,logplot=1):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-156.png}
\begin{eulerprompt}
>plot2d("log(x*(2+sin(x/100)))",10,1000,logplot=3):
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-157.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 2D_Afra Putri Soliana_22305144025-158.png}
\begin{eulerprompt}
>  
\end{eulerprompt}
