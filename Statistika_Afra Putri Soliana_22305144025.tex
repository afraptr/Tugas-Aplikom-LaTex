...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-002.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-003.png}
\eulerheading{Tabel}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-004.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-005.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-008.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-009.png}
\begin{eulerformula}
\[
\text{normaldis(x,m,d)}=\int_{-\infty}^x \frac{1}{d\sqrt{2\pi}}e^{-\frac{1}{2}(\frac{t-m}{d})^2}\ dt.
\]
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-012.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-013.png}
\begin{eulercomment}
...
>statplot(YT,BT1,"b"):
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-015.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-016.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-017.png}
\begin{eulercomment}
...
>  angle=30°,ccols=CP):
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-018.png}
\begin{eulercomment}
...
>shrinkwindow():
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-019.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-020.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-021.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-022.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-023.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-024.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-025.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-026.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-027.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-028.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-029.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-030.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-031.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-032.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-033.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-034.png}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  [3,  18,  25,  38,  52,  107,  109,  142,  127,  127,  98,  64,  40,
  31,  15,  4]
\end{euleroutput}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-037.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-038.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-039.png}
\eulerheading{Tes}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-040.png}
\begin{eulerprompt}
>t=count(R,21);
\end{eulerprompt}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-041.png}
\begin{eulercomment}
Hapus datanya.
\end{eulercomment}
\begin{eulerprompt}
...
>statplot(u,f,"h"):
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-042.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-043.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-044.png}
\eulerheading{Daftar}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
    0.65542     0.201   0.89362 
    0.28189     0.525   0.31413 
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Afra Putri Soliana_22305144025-045.png}
\begin{eulercomment}
...
Menghitung rata-rata dan deviasi
\end{eulercomment}
\begin{eulerprompt}
...
>aspect(3); boxplot(A):
\end{eulerprompt}
\eulerimg{8}{images/Statistika_Afra Putri Soliana_22305144025-046.png}
\begin{eulercomment}
2) nilai ulangan matematika kelas 6
\end{eulercomment}
\begin{eulerprompt}
>r=65:5:100; v=[3,7,4,3,7,5,6];
>plot2d(r,v,a=60,b=100,c=0,d=8,bar=1,style="-"):
\end{eulerprompt}
\eulerimg{8}{images/Statistika_Afra Putri Soliana_22305144025-047.png}
\begin{eulerprompt}
>T:=r[1:7]' | r[2:8]' | v'; writetable(T,labc=["BB","BA","Frek"])
\end{eulerprompt}
\begin{euleroutput}
          BB        BA      Frek
          65        70         3
...
>figure(0):
\end{eulerprompt}
\eulerimg{8}{images/Statistika_Afra Putri Soliana_22305144025-048.png}
\begin{eulercomment}
4) Dari 12 siswa, sampel 8 orang diambil untuk mengukur tinggi badan
mereka. Data berikut diperoleh: 165,171,163,155,160,170,160,158.
Hitung deviasi sampel standar dari data.
\end{eulercomment}
\begin{eulerprompt}
>V=[165,171,163,155,160,170,160,158]
\end{eulerprompt}
\begin{euleroutput}
  [165,  171,  163,  155,  160,  170,  160,  158]
\end{euleroutput}
\begin{eulerprompt}
>dev(V)
\end{eulerprompt}
