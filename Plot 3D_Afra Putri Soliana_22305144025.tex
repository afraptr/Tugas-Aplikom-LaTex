...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-001.png}
\begin{eulerprompt}
>plot3d("x^2+x*sin(y)+2*y",-5,5,9,6*pi):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-002.png}
\begin{eulercomment}
...
>plot3d("x^2+y^2"):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-004.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-005.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-008.png}
\begin{eulercomment}
Polar kutub juga tersedia. The parameter polar=true menggambarkan plot
...
tidak, fungsi diskalakan agar sesuai dengan kutub.
\end{eulercomment}
\begin{eulerprompt}
>plot3d("1/(x^2+y^2+1)",r=5,>polar, ...
>fscale=2,>hue,n=100,zoom=4,>contour,color=blue):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-009.png}
\begin{eulerprompt}
>function f(r) := exp(-r/2)*cos(r); ...
>plot3d("f(x^2+y^2)",>polar,scale=[1,1,0.4],r=2pi,frame=3,zoom=4):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-010.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-011.png}
\begin{eulerprompt}
>plot3d("x^2+1",a=-1,b=1,rotate=2,grid=5):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-012.png}
\begin{eulerprompt}
>plot3d("sqrt(25-x^2)",a=0,b=5,rotate=1): 
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-013.png}
\begin{eulerprompt}
>plot3d("x*sin(x)",a=0,b=6pi,rotate=2):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-014.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-015.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-016.png}
\begin{eulerprompt}
>plot3d("exp(x*y)",angle=100°,>contour,color=green):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-017.png}
\begin{eulercomment}
...
menambah jumlah poin untuk men-dapatkan tampilan yang sangat mulus.
\end{eulercomment}
\begin{eulerprompt}
>plot3d("x^2+y^2",>spectral,>contour,n=100):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-019.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-020.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-022.png}
\begin{eulercomment}
Dimungkinkan untuk menunjukkan bidang kontur di bawah plot. Warna dan
jarak ke plot dapat diten-tukan.
\end{eulercomment}
\begin{eulerprompt}
>plot3d("x^2+y^4",>cp,cpcolor=green,cpdelta=0.2):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-023.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-024.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-025.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-026.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-027.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-028.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-029.png}
\eulerheading{Implicit Plots}
\begin{eulercomment}
Ada juga plot implisit dalam tiga dimensi. Euler
menghasilkanpemotongan melalui objek. Fitur plot3d termasuk plot
implisit. Plot ini menunjukkan himpunan nol fungsi dalam tiga
variabel.\\
Solusi dari
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-032.png}
\begin{eulerprompt}
>c=1; d=1;
>plot3d("((x^2+y^2-c^2)^2+(z^2-1)^2)*((y^2+z^2-c^2)^2+(x^2-1)^2)*((z^2+x^2-c^2)^2+(y^2-1)^2)-d",r=2,<frame,>implicit,>user): 
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-033.png}
\begin{eulerprompt}
> 
\end{eulerprompt}
\begin{euleroutput}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-034.png}
\eulerheading{Plotting 3D Data}
\begin{eulercomment}
Sama seperti plot2d, plot3d menerima data. Untuk objek 3D, Andaperlu
memberikan matriks nilai x, y dan z, atau tiga fungsi atau ekspresi
...
nilai s untuk membuat pa-rameter permukaan bola. Dalam gambar kita
bisa menandai daerah, dalam kasus kita daerah kutub.
\end{eulercomment}
\begin{eulerprompt}
...
>scale=1.4,height=50°):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-037.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-039.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-043.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-044.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-045.png}
\begin{eulerprompt}
>t=linspace(0,4pi,1000); plot3d(cos(t),sin(t),t/2pi,>wire, ...
>linewidth=3,wirecolor=blue):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-046.png}
\begin{eulerprompt}
>X=cumsum(normal(3,100)); ...
> plot3d(X[1],X[2],X[3],>anaglyph,>wire):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-048.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-049.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-050.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-051.png}
\eulerheading{Statistical Plot}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-052.png}
\begin{eulercomment}
Ini memungkinkan untuk membagi plot permukaan menjadi dua bagian atau
lebih.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-053.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-054.png}
\begin{eulerprompt}
>Z=intrandom(5,100,6); v=zeros(5,6); ...
>loop 1 to 5; v[#]=getmultiplicities(1:6,Z[#]); end; ...
>columnsplot3d(v',scols=1:5,ccols=[1:5]):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-055.png}
...
>level=[-2;0],n=100):
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-056.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-061.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-062.png}
...
\end{eulerprompt}
\eulerimg{17}{images/Plot 3D_Afra Putri Soliana_22305144025-063.png}
\begin{eulercomment}
...
>myplot(x,y,z):
\end{eulerprompt}
\eulerimg{27}{images/Plot 3D_Afra Putri Soliana_22305144025-064.png}
...
\end{eulerprompt}
\eulerimg{27}{images/Plot 3D_Afra Putri Soliana_22305144025-065.png}
...
atau menyetel variabel ”default-povray” dengan jalur lengkap yang
...
Y, Z dalam matriks, termasuk garis level opsional. Fungsi ini memulai
raytracer secara otomatis, dan memuat pemandangan ke dalam notebook
Euler.
...
menghasilkan file povray di direk-tori pengguna Anda, dan menjalankan
Povray untuk menelusuri file ini.

Jika Anda memulai perintah berikut, GUI Povray akan terbuka,
menjalankan file, dan menutup secara otomatis. Karena alasan keamanan,
Anda akan ditanya, apakah Anda ingin mengizinkan file exe di-jalankan.
...
\end{eulerprompt}
\eulerimg{27}{images/Plot 3D_Afra Putri Soliana_22305144025-066.png}
\begin{eulerprompt}
>pov3d("x^2+y^2",zoom=3);
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D_Afra Putri Soliana_22305144025-067.png}
\begin{eulercomment}
Kita bisa membuat fungsinya transparan dan menambahkan hasil akhir
lainnya. Kita juga bisa menam-bahkan garis level ke plot fungsi.
\end{eulercomment}
\begin{eulerprompt}
...
>  <fscale,zoom=3.8);
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D_Afra Putri Soliana_22305144025-068.png}
...
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D_Afra Putri Soliana_22305144025-069.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D_Afra Putri Soliana_22305144025-070.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D_Afra Putri Soliana_22305144025-071.png}
\begin{eulercomment}
Dengan povgrid (), kurna dimungkinkan.
\end{eulercomment}
\begin{eulerprompt}
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D_Afra Putri Soliana_22305144025-072.png}
...
>povend;
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D_Afra Putri Soliana_22305144025-073.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D_Afra Putri Soliana_22305144025-074.png}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D_Afra Putri Soliana_22305144025-075.png}
...
\end{euleroutput}
\begin{eulerprompt}
>povstart(angle=45°,height=10°); 
>writeln(povsurface("pow(x,2)+pow(y,2)*pow(z,2)-1",povlook(blue),povbox(-2,2,"")));
>povend();
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D_Afra Putri Soliana_22305144025-077.png}
\begin{eulerprompt}
>povstart(angle=70°,height=50°,zoom=4);
\end{eulerprompt}
\begin{eulercomment}
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D_Afra Putri Soliana_22305144025-078.png}
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D_Afra Putri Soliana_22305144025-079.png}
...
\end{eulerprompt}
\eulerimg{27}{images/Plot 3D_Afra Putri Soliana_22305144025-080.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Plot 3D_Afra Putri Soliana_22305144025-081.png}
\eulerheading{Defining own Objects (Mendefinisikan Objek Sendiri)}
\begin{eulercomment}
...
\end{euleroutput}
\begin{eulercomment}
Sekarang kita menempatkan objek ini ke dalam sebuah adegan. Untuk
...
>povend(h=320,w=480);
\end{eulerprompt}
\eulerimg{18}{images/Plot 3D_Afra Putri Soliana_22305144025-082.png}
\begin{eulercomment}
...
\end{euleroutput}
\begin{eulercomment}
Ya, contoh ini memiliki solusi.

Selanjutnya, kita definisikan dua objek. Yang pertama 
...
\end{eulerprompt}
\begin{eulercomment}
Dan ada kesalah di arah optimal.
\end{eulercomment}
\begin{eulerprompt}
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/Plot 3D_Afra Putri Soliana_22305144025-085.png}
